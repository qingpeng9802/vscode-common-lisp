...
function getCallHierarchyCallsByCallHierarchyItem(
  ...
  callHierarchyCallsDict: Record<string, Record<string, vscode.CallHierarchyOutgoingCall>>):
  vscode.CallHierarchyOutgoingCall[];
function getCallHierarchyCallsByCallHierarchyItem(
  item: vscode.CallHierarchyItem,
  callHierarchyCallsDict: Record<string, Record<string, vscode.CallHierarchyIncomingCall>>):
