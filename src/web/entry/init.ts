...
function setDirtyHookForStructuredInfo(
  contextSubcriptions: vscode.Disposable[],
  traceableDisposables: TraceableDisposables,
  structuredInfo: StructuredInfo
) {
  ...
  // Therefore, it is safe to use `onDidChangeTextDocument` and `onDidChangeActiveTextEditor` event
  // to mark dirty on the StructuredInfo.
